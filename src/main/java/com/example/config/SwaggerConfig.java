...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Demo")
                .description("Homework for Back End Java Developer")
                .version("1.0.0").license("Apache License Version 2.0")
                .licenseUrl("https://www.apache.org/licenses/LICENSE-2.0")
                .contact(new Contact("Rodrigo Erazo Hermosilla", "https://example.com", "rodrigoerazo@gmail.com"))
                .build();
    }
        ...
        return new ArrayList<ResponseMessage>() {
...

            {
                add(new ResponseMessageBuilder()
                        .code(500)
                        .message("500 message")
                        .responseModel(new ModelRef("Server Error")).build());
                add(new ResponseMessageBuilder()
                        .code(403)
                        .message("Forbidden")
                        .build());
